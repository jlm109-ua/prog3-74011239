...
public class FightersPreTest {
	...
	public void testCopy() {
		...
		Fighter b = FighterFactory.createFighter("TIEBomber", rebelShip);
		Fighter f = FighterFactory.createFighter("TIEFighter", rebelShip);
		Fighter i = FighterFactory.createFighter("TIEInterceptor", rebelShip);
		
		assertEquals("copy AWing",fa,fa.copy());
		assertEquals("copy TIEBomber",b,b.copy());
		assertEquals("copy TIEFighter",f,f.copy());
		assertEquals("copy TIEInterceptor",i,i.copy());
